...
Blockly.Msg.COLLAPSE_BLOCK = "Colapsar Bloque";
Blockly.Msg.COLOUR_BLEND_COLOUR1 = "Color 1";
Blockly.Msg.COLOUR_BLEND_COLOUR2 = "Color 2";
Blockly.Msg.COLOUR_BLEND_HELPURL = "http://meyerweb.com/eric/tools/color-blend/";
Blockly.Msg.COLOUR_BLEND_RATIO = "Proporcion";
Blockly.Msg.COLOUR_BLEND_TITLE = "mezcla";
Blockly.Msg.COLOUR_BLEND_TOOLTIP = "Mezclar dos colores a un razón dada (0.0 - 1.0).";
...
Blockly.Msg.CONTROLS_FLOW_STATEMENTS_OPERATOR_CONTINUE = "continue con la siguiente interaccion del bucle";
Blockly.Msg.CONTROLS_FLOW_STATEMENTS_TOOLTIP_BREAK = "salir del bucle del contenedor.";
Blockly.Msg.CONTROLS_FLOW_STATEMENTS_TOOLTIP_CONTINUE = "Omita el resto de este ciclo y continúe con la siguiente iteración.";
Blockly.Msg.CONTROLS_FLOW_STATEMENTS_WARNING = "Advertencia: este bloque solo puede usarse dentro de un bucle.";
Blockly.Msg.CONTROLS_FOREACH_HELPURL = "https://github.com/google/blockly/wiki/Loops#for-each";
Blockly.Msg.CONTROLS_FOREACH_TITLE = "para cada elemento% 1 en la lista% 2";
Blockly.Msg.CONTROLS_FOREACH_TOOLTIP = "Para cada elemento de una lista, establezca la variable '% 1' en el elemento y luego haga algunas declaraciones.";
Blockly.Msg.CONTROLS_FOR_HELPURL = "https://github.com/google/blockly/wiki/Loops#count-with";
Blockly.Msg.CONTROLS_FOR_TITLE = "cuente con% 1 de% 2 a% 3 por% 4";
Blockly.Msg.CONTROLS_FOR_TOOLTIP = "Haga que la variable '% 1' tome los valores desde el número inicial hasta el número final, contando por el intervalo especificado, y realice los bloques especificados.";
Blockly.Msg.CONTROLS_IF_ELSEIF_TOOLTIP = "Agregue una condición al bloque if.";
...
Blockly.Msg.LISTS_SPLIT_LIST_FROM_TEXT = "haga una lista de texto";
Blockly.Msg.LISTS_SPLIT_TEXT_FROM_LIST = "haga texto de la lista";
...
Blockly.Msg.MATH_IS_WHOLE = "es todo";
...
Blockly.Msg.MATH_ONLIST_OPERATOR_MODE = "modos de lista";
...
Blockly.Msg.MATH_ROUND_OPERATOR_ROUND = "redondo";
Blockly.Msg.MATH_ROUND_OPERATOR_ROUNDDOWN = "edondear abajo";
...
Blockly.Msg.MATH_TRIG_ACOS = "arco coseno";
Blockly.Msg.MATH_TRIG_ASIN = "arco seno";
Blockly.Msg.MATH_TRIG_ATAN = "arco tan";
...
Blockly.Msg.PROCEDURES_DEFNORETURN_COMMENT = "describe esta funcion...";
...
Blockly.Msg.PROCEDURES_MUTATORCONTAINER_TOOLTIP = "Añadir, eliminar, o reordenar entradas a esta funcion.";
...
Blockly.Msg.TEXT_CHARAT_FIRST = "Obtenga la primera carta";
Blockly.Msg.TEXT_CHARAT_FROM_END = "get letter # from end";
Blockly.Msg.TEXT_CHARAT_FROM_START = "obtener carta#";
...
Blockly.Msg.TEXT_INDEXOF_OPERATOR_LAST = "encontrar la última aparición de texto";
